...
parser.add_argument("--disable-frontend", action="store_true", help="Disable serving the frontend web interface. Only API endpoints will be available.")
...
if args.disable_frontend:
    args.auto_launch = False  # Cannot launch browser if frontend is disabled
